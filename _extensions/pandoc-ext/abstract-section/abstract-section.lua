...
Pandoc = function(doc)
	...
	-- configure
	section_identifiers_list = (doc.meta["abstract-section"] or {})["section-identifiers"]
	...
	elseif PANDOC_VERSION >= { 2, 9, 2 } then
		...
		-- `walk_block` function.
		blocks = pandoc.utils.walk_block(pandoc.Div(doc.blocks), { Blocks = abstract_from_blocklist }).content
	else
